<form class="row g-3" action="{{ route('skripsi.update', $data->semester_aktif) }}" method="POST" enctype="multipart/form-data">
    @csrf
    @method('PUT')
    ...
    <div class="col-6">
        ...
        <input type="date" class="form-control" id="tanggal_sidang" name="tanggal_sidang" value="{{ $data->tanggal_sidang }}">
    </div>
    <!-- Input Tanggal END -->
